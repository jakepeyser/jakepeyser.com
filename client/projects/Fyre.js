...
export default {
  ...
  summary: {
    ...
    Technology: ['Vue.js', 'Vuex', 'Node.js', 'Express', 'Ruby', 'Grape', 'MongoDB', 'AWS', 'Codeship', 'Docker', 'Elasticsearch', 'Cloudinary']
  },
  ...
  images: ['talent_search.png', 'nav_search.png', 'make_offer.png', 'concierge.png', ['offer_submitted_modal.png', 'offer_revision_modal.png'], 'offer_negotiation.png', ['offer_cancel_modal.png', 'offer_accept_modal.png'], 'offer_list.png', 'profile_settings.png' ]
}
