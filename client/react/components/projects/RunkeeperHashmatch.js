...
export default {
  ...
  component: () =>
    <div className="project__images">
      <img src={ getStaticResourceLink('images/runkeeper-hashmatch/screenshot.png') } alt="Jack Dorsey Personality Match Results" />
      <img src={ getStaticResourceLink('images/runkeeper-hashmatch/mobile.png') } alt="Barack Obama Personality Match Results" />
    </div>
}
